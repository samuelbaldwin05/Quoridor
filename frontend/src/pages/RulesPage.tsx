        ...
        <div className="rules-page-content">
          ...
          <div className="rules-section">
            ...
            <p>
              ...
              any square on the far row. You start at the bottom and win by reaching the top
          ...
          <div className="rules-section">
            ...
            <ul>
              ...
              <li>
                You can't place a fence that completely traps your opponent, they must always have
